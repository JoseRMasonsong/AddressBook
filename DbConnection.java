...
public class DbConnection extends JFrame {
   ...
   public DbConnection()
   {
      ...
      // connect to database AddressBook and query database
      try {
         // load database driver class
    	  Class.forName("org.sqlite.JDBC");

         // connect to database
         Connection connection = DriverManager.getConnection("jdbc:sqlite:C:\\sqlite\\DB Browser for SQLite\\addressbook.db"); //Replace with your path to your database
